...
- **Arrows/connectors**: Arrows and connectors must be bidirectionally linked to their target elements (i.e., they must bind to element IDs)
- **Coordinate planning**: Plan the layout in advance and set generous spacing between elements (greater than 800px) to avoid overlaps
- **Size consistency**: Keep similar element types at consistent sizes to establish visual rhythm
...
- **Color scheme**: Use 2–4 primary colors for visual consistency
