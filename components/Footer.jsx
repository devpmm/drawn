...
import { BORDER_COLOR, NAV_BG } from '@/lib/constants';
...
export default function Footer() {
  return (
    <footer style={{ padding: '12px 32px', borderTop: `0.5px solid ${BORDER_COLOR}`, background: NAV_BG, textAlign: 'center', fontSize: '11px', color: '#aaa', marginTop: '16px' }}>
      ...
      {' · '}
      <a
        href="https://github.com/devpmm/drawn"
        target="_blank"
        rel="noopener noreferrer"
        style={{ color: '#aaa', textDecoration: 'none' }}
      >
        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style={{ display: 'inline', verticalAlign: 'middle', marginRight: '3px' }}>
