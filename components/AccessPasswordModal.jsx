    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded border border-gray-300 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Access Password</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div className="px-4 py-3 bg-blue-50 border border-blue-200 rounded">
            ...
            <p className="text-sm text-blue-800">• The access password takes priority over your local LLM config</p>
            <p className="text-sm text-blue-800">• When enabled, the server-side LLM configuration is used instead</p>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              {isValidating ? 'Verifying...' : 'Verify Password'}
            </button>
          </div>
        </div>
